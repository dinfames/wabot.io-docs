...
- Includes broadcast, chatbot, and API sends
- **View Analytics** button for a detailed breakdown

### AI Credits
- Monthly allowance (e.g. `1 / 50K`)
- Purchased top-ups
- Advance credits (on/off)
...
| **Admin Tools** | Persona templates and admin utilities |
| **Membership** | Billing and plan management |
| **Settings** | Admin-level settings |

### TEAM
- Shows the active team. Click to switch teams if you belong to more than one.
